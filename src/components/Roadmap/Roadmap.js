...
import { SectionAbout, SectionTeam, SecondaryBtn, SectionTitle, ListTitle } from './RoadmapStyles'
...
const Roadmap = () => {
  return (
    <SectionTeam id="roadmap" >
        ...
        <SectionAbout>
       <ListTitle> The OG Wanderer collection will include 6060 NFTs.<br/></ListTitle>
        ...
        <br/>
       <ListTitle> Referral Program:<br/></ListTitle> Any verified member, meaning you have Checked In by minting an OG Wanderer, 
